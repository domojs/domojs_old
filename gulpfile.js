...
modules.forEach(function (m) {
    ...
    gulp.add('build-' + m + '-typescript', function () {
        ...
        return merge(tsResult.js
            ...
            .pipe(gulp.dest("modules/" + m + "/dist/server")), tsResult.dts.pipe(gulp.dest("modules/" + m + "/dist/server")));
    });
    ...
    gulp.add('build-' + m + '-client-typescript', function () {
        if (fs.existsSync("modules/" + m + "/src/client/tsconfig.json")) {
            ...
            return merge(tsResult.js
                ...
                .pipe(gulp.dest("modules/" + m + "/dist/client")), tsResult.dts.pipe(gulp.dest("modules/" + m + "/dist/client")));
        }
    });
